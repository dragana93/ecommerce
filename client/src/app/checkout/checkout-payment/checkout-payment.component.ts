...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe(
      'pk_test_51QFbVwACJr2mDeT483da5LAbcXXvfy1K4kX2iG9ctx3t7bQ7MNf6WNpk3oI7NjguRCLZ9Ri0zzkq4RJjLvaGkd8400rjmGqhZd'
    ).then((stripe) => {
      this.stripe = stripe;
  ...
  private async createOrder(basket: Basket | null) {
    ...
    return this.checkoutService.createOrder(orderToCreate).toPromise(); //firstValueFrom(this.checkoutService.createOrder(orderToCreate)) - new RxJS version
  }
